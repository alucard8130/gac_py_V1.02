...
class EditContratoData():
    def editar(self, info:EditContrato):
        ...
        query=(
            """UPDATE contratos SET  fecha_inicio = '{}', fecha_fin = '{}', cuota_mensual = '{}', deposito_garantia = '{}',
            status_activo = '{}', usuario = '{}', fecha_reg = '{}' WHERE num_contrato = '{}'"""
            .format(info._fechaInicio, info._fechaFin, info._cuota, info._deposito, info._statusContrato, info._usuarioReg, info._fechaReg, info._numContrato)
