...
"color: rgb(216, 224, 236);")
        ...
        self.frame_2.setGeometry(QRect(0, 70, 681, 351))
...
"background-color: rgb(245, 245, 252);")
        ...
        self.txtNombreCliente.setGeometry(QRect(20, 90, 280, 30))
...
"border-radius:5px;")
        ...
        self.label_4.setGeometry(QRect(20, 270, 49, 21))
        self.txtDireccion = QTextEdit(self.frame_2)
        self.txtDireccion.setObjectName(u"txtDireccion")
        self.txtDireccion.setGeometry(QRect(370, 280, 281, 51))
...
"border-radius:5px;")
        ...
        self.cmbTipoContribuyente.setGeometry(QRect(20, 220, 280, 30))
        self.cmbTipoContribuyente.setStyleSheet(u"background-color: rgb(255, 255, 255);\n"
"border-radius:5px;")
        self.label_3 = QLabel(self.frame_2)
        self.label_3.setObjectName(u"label_3")
        self.label_3.setGeometry(QRect(20, 200, 111, 21))
        self.label_8 = QLabel(self.frame_2)
        self.label_8.setObjectName(u"label_8")
        self.label_8.setGeometry(QRect(370, 260, 49, 16))
        self.groupBox = QGroupBox(self.frame_2)
        self.groupBox.setObjectName(u"groupBox")
        self.groupBox.setGeometry(QRect(20, 10, 280, 41))
        self.groupBox.setStyleSheet(u"")
        self.checkBoxStatus = QCheckBox(self.groupBox)
        self.checkBoxStatus.setObjectName(u"checkBoxStatus")
        self.checkBoxStatus.setGeometry(QRect(180, 10, 93, 16))
        self.checkBoxStatus.setStyleSheet(u"border-color: rgb(0, 0, 0);")
        self.label_5 = QLabel(self.frame_2)
        self.label_5.setObjectName(u"label_5")
        self.label_5.setGeometry(QRect(370, 10, 49, 21))
        self.label_7 = QLabel(self.frame_2)
        self.label_7.setObjectName(u"label_7")
        self.label_7.setGeometry(QRect(380, 140, 31, 16))
        self.label_9 = QLabel(self.frame_2)
        self.label_9.setObjectName(u"label_9")
        self.label_9.setGeometry(QRect(370, 70, 111, 16))
        self.txtRFC = QLineEdit(self.frame_2)
        self.txtRFC.setObjectName(u"txtRFC")
        self.txtRFC.setGeometry(QRect(20, 160, 280, 30))
...
"")
        ...
        self.txtEmail.setGeometry(QRect(370, 30, 281, 30))
...
"border-radius:5px;")
        ...
        self.txtCel.setGeometry(QRect(370, 90, 281, 30))
...
"border-radius:5px;")
        ...
        self.txtGiro.setGeometry(QRect(370, 160, 281, 30))
...
"border-radius:5px;")
        ...
        self.txtCURP.setGeometry(QRect(20, 290, 280, 30))
...
"border-radius:5px;")
        ...
        self.label_10.setGeometry(QRect(20, 70, 111, 16))
        self.label_11 = QLabel(self.frame_2)
        self.label_11.setObjectName(u"label_11")
        self.label_11.setGeometry(QRect(20, 140, 31, 16))
        self.label_12 = QLabel(self.frame_2)
        self.label_12.setObjectName(u"label_12")
        self.label_12.setGeometry(QRect(370, 200, 111, 21))
...
"border-radius:5px;")
        ...
        self.btnGuardar.setGeometry(QRect(20, 20, 280, 30))
        font1 = QFont()
...
"")
        ...
        self.btnSalir.setGeometry(QRect(370, 20, 281, 30))
