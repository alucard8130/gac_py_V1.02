...
"background-color: rgb(245, 245, 252);")
        ...
        self.cmb_prov = QtWidgets.QComboBox(parent=self.groupBox_2)
        self.cmb_prov.setEnabled(True)
        self.cmb_prov.setGeometry(QtCore.QRect(60, 60, 291, 30))
...
"border-radius:5px;")
        ...
        self.radioButton_tgasto.setGeometry(QtCore.QRect(30, 100, 89, 20))
...
"color: rgb(0, 0, 0);")
        ...
        self.lblTipo_Gtos = QtWidgets.QLabel(parent=formClientes)
        self.lblTipo_Gtos.setGeometry(QtCore.QRect(210, 430, 81, 16))
        self.lblTipo_Gtos.setObjectName("lblTipo_Gtos")
        self.cmb_empleados = QtWidgets.QComboBox(parent=formClientes)
        self.cmb_empleados.setGeometry(QtCore.QRect(380, 450, 191, 30))
        self.cmb_empleados.setStyleSheet("background-color: rgb(255, 255, 255);\n"
"border-radius:5px;")
        self.cmb_empleados.setObjectName("cmb_empleados")
        self.cmb_empleados.addItem("")
        self.lblTrabajador = QtWidgets.QLabel(parent=formClientes)
        self.lblTrabajador.setGeometry(QtCore.QRect(380, 430, 71, 16))
        self.lblTrabajador.setObjectName("lblTrabajador")
        self.cmb_tipo_gtos = QtWidgets.QComboBox(parent=formClientes)
        self.cmb_tipo_gtos.setGeometry(QtCore.QRect(160, 450, 191, 30))
        self.cmb_tipo_gtos.setStyleSheet("background-color: rgb(255, 255, 255);\n"
"border-radius:5px;")
        self.cmb_tipo_gtos.setObjectName("cmb_tipo_gtos")
        self.cmb_tipo_gtos.addItem("")
        self.cmb_tipo_gtos.addItem("")
        self.cmb_tipo_gtos.addItem("")
        self.cmb_tipo_gtos.addItem("")
        self.cmb_tipo_gtos.addItem("")
    ...
    def retranslateUi(self, formClientes):
        ...
        self.cmb_prov.setPlaceholderText(_translate("formClientes", "selecciona una opcion"))
        self.cmb_prov.setItemText(0, _translate("formClientes", "---seleccione una opcion----"))
        ...
        self.lblTipo_Gtos.setText(_translate("formClientes", "Tipo Gasto"))
        self.cmb_empleados.setItemText(0, _translate("formClientes", "-selecciona una opcion-"))
        self.lblTrabajador.setText(_translate("formClientes", "Trabajador"))
        self.cmb_tipo_gtos.setItemText(0, _translate("formClientes", "--selecciona una opcion--"))
        self.cmb_tipo_gtos.setItemText(1, _translate("formClientes", "conservacion"))
        self.cmb_tipo_gtos.setItemText(2, _translate("formClientes", "operacion"))
        self.cmb_tipo_gtos.setItemText(3, _translate("formClientes", "administrativo"))
        self.cmb_tipo_gtos.setItemText(4, _translate("formClientes", "nomina"))
        self.cmb_tipo_gtos.setItemText(5, _translate("formClientes", "impuestos"))
        self.cmb_tipo_gtos.setItemText(6, _translate("formClientes", "oficina"))
        self.cmb_tipo_gtos.setItemText(7, _translate("formClientes", "seguridad social (IMSS)"))
        self.cmb_tipo_gtos.setItemText(8, _translate("formClientes", "asamblea"))
        self.cmb_tipo_gtos.setItemText(9, _translate("formClientes", "comite"))
        self.cmb_tipo_gtos.setItemText(10, _translate("formClientes", "no deducible"))
        self.cmb_tipo_gtos.setItemText(11, _translate("formClientes", "extraordinario"))
        self.cmb_tipo_gtos.setItemText(12, _translate("formClientes", "financiero"))
        self.cmb_tipo_gtos.setItemText(13, _translate("formClientes", "estacionamiento"))
        self.cmb_tipo_gtos.setItemText(14, _translate("formClientes", "publicidad"))
        self.cmb_tipo_gtos.setItemText(15, _translate("formClientes", "eventos"))
        self.cmb_tipo_gtos.setItemText(16, _translate("formClientes", "otro"))
